...
def build_parser():
    ...
    parser.add_argument("--frepr", type=str, required=True, help="Cluster representation file names")
    parser.add_argument("-n", type=int, help="nsamples for each params")
    parser.add_argument("--fdir_out", type=str, required=True, help="output directory")
    parser.add_argument("--mtype", choices=("mfast", "mslow", "regular"), default="regular",
                        type=str, help="output directory")
    parser.add_argument("--seed", type=int, default=42)
    return parser


def main(frepr="", n=200, fdir_out="./data", mtype="", seed=42):
    np.random.seed(seed)
    nsamples_for_each = n
    
    with open(frepr, "rb") as fp:
    ...
    write_selected_points(fdir_out, seed, id_tot)
